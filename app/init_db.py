...
# {'allo_id': 2, 'allo_nom': "Allô snack", 'allo_debut': datetime.time.min, 'allo_fin': datetime.time(20), 'se_reserve': True},

allos = [
    {'allo_id': 1, 'allo_nom': 'Allô crêpe', 'allo_debut': datetime.time.min, 'allo_fin': datetime.time.max, 'se_reserve': False},
    {'allo_id': 3, 'allo_nom': "Allô fastfood", 'allo_debut': datetime.time.min, 'allo_fin': datetime.time(19), 'se_reserve': True},
    ...
    {'allo_id': 10, 'allo_nom': 'Allô lessive', 'allo_debut': datetime.time.min, 'allo_fin': datetime.time.max, 'se_reserve': True},
